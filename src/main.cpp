...
// Constructor
ADS129xSensor adsSensor(IPIN_CS, IPIN_DRDY, IPIN_RESET);
...
void setup() {
  ...
  adsSensor.writeRegister(ads::registers::config1::REG_ADDR, ads::registers::config1::LOW_POWR_16k_SPS);
  ...
  adsSensor.enableChannelAndSetGain(2, ads::registers::chnSet::GAIN_6X, ads::registers::chnSet::TEST_SIGNAL);
  Serial.println("Channel 3: power-down and its inputs shorted (as Texas Instruments recommends)");
  adsSensor.enableChannelAndSetGain(3, ads::registers::chnSet::GAIN_6X, ads::registers::chnSet::TEST_SIGNAL);
